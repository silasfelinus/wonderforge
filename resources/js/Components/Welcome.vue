    ...
    <div>
        ...
        >
            ...
            <h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white">
                Cafe Purr, Next Generation Art Gallery! (Member's Page)
            </h1>

            <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
                If you're reading this, then you actually bothered to sign in and see what was on offer.
            Unfortunately, at this point, I'm still under construction. Feel free to check out our 
            </p>
        </div>
